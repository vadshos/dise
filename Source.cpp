...
int excellent = 0;
float BestGroup = 0;
int IndexWorstGroup = 0;#include<iostream>
#include<ctime>
#include<conio.h>
#include"windows.h"
...
int main() {
    ...
    for (int i = 0; i < gr; i++) {
        ...
        int achion = 1;
        setlocale(LC_ALL, "");
        string  ach[] = { "1-Вивести усіх відмінників.","2- Вивести  керівника, в класі якого найкраща успішність.","3- Вивести назву класа з найгіршою успішністю.","4- Вивести всіх братів і сестер.","5- Вивести дітей, які народились в один день.","6- Вивести найстаршого учня.","7- Скільки учнів мають середній бал більше 8.5 ?","8-В якому класі найбільше пільговиків ?" };
        int a = 0;
        while (a != 13) {
            system("cls");
            for (int i = 0; i < 8; i++) {
